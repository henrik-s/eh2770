...
\begin{center}
	\begin{figure}[H]
		...
		\setlength\fboxsep{7pt}
		\setlength\fboxrule{0.5pt}
		\fbox{\includegraphics[scale = 0.05]{images/map_order.png}}
...
\begin{center}
	\begin{figure}[H]
		...
		\setlength\fboxsep{7pt}
		\setlength\fboxrule{0.5pt}
		\fbox{\includegraphics[scale = 0.05]{images/map_claim.png}}
...
\begin{center}
	\begin{figure}[H]
		...
		\setlength\fboxsep{7pt}
		\setlength\fboxrule{0.5pt}
		\fbox{\includegraphics[scale = 0.05]{images/map_mail.png}}
...
\begin{center}
	\begin{figure}[H]
		...
		\setlength\fboxsep{7pt}
		\setlength\fboxrule{0.5pt}
		\fbox{\includegraphics[scale = 0.05]{images/map_phone.png}}
...
\begin{center}
	\begin{figure}[H]
		...
		\setlength\fboxsep{7pt}
		\setlength\fboxrule{0.5pt}
		\fbox{\includegraphics[scale = 0.05]{images/map_pay.png}}
